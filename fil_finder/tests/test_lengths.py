...
def test_length4():
    ...
    test_skel4[posns[0], posns[1]] = 1

    length4 = skeleton_length(test_skel4)

    exp_length = 11 * np.sqrt(2) + 5

    assert length4 == exp_length
...
def test_length5():
    ...
    test_skel5[posns[0], posns[1]] = 1

    length5 = skeleton_length(test_skel5)

    exp_length = 10 + 7 * np.sqrt(2)

    assert length5 == exp_length

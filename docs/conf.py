# -*- coding: utf-8 -*-
#
# fil_finder documentation build configuration file, created by
...
MOCK_MODULES = ['matplotlib', 'astropy', 'scipy', 'scikits-image', 'numpy', 'pandas', "networkx"]
...
latex_documents = [
  ('index', 'fil_finder.tex', u'fil\\_finder Documentation',
